...
/* Assistant launcher is owned exclusively by assets/js/ato-assistant.js. */
...
(function atoInitMobileV6Fixes(){
  ...
  /* Assistant launcher intentionally not inspected or mutated here. */
  const applyAll = () => {
    if (!isMobile()) return;
    fixLanguageClose();
    fixHeroArrow();
