...
#atoGlobalHeaderRoot .language-menu .ato-v8-lang-code{
  grid-column:1!important;align-self:center!important;justify-self:stretch!important;width:100%!important;min-width:0!important;height:30px!important;
  display:flex!important;align-items:center!important;justify-content:center!important;padding:0 12px 0 8px!important;
  border-right:1px solid rgba(221,180,93,.24)!important;color:#e1bb69!important;box-sizing:border-box!important;
}
#atoGlobalHeaderRoot .ato-grid-symbol .ato-cat-svg{
  width:19px!important;height:19px!important;display:block!important;fill:none!important;stroke:currentColor!important;stroke-width:1.55!important;
  stroke-linecap:round!important;stroke-linejoin:round!important;vector-effect:non-scaling-stroke!important;
}
#atoGlobalHeaderRoot .ato-dropdown-label,
#atoGlobalHeaderRoot .language-menu .ato-lang-name,
#atoGlobalHeaderRoot .language-menu .ato-v8-lang-name{
  grid-column:2!important;min-width:0!important;padding-left:14px!important;color:inherit!important;font:inherit!important;letter-spacing:inherit!important;
}
#atoGlobalHeaderRoot .ato-lang-check{
  grid-column:3!important;display:block!important;justify-self:end!important;color:#e4bb65!important;font-size:13px!important;font-weight:700!important;
  opacity:0!important;transform:scale(.85)!important;transition:opacity .18s ease,transform .18s ease!important;
}
#atoGlobalHeaderRoot .language-menu a.is-active .ato-lang-check{opacity:1!important;transform:scale(1)!important}
#atoGlobalHeaderRoot .language-menu a.is-active,
#atoGlobalHeaderRoot .ato-grid-row.is-current{
  background:linear-gradient(90deg,rgba(221,180,93,.12),rgba(221,180,93,.055))!important;
  border-color:rgba(221,180,93,.34)!important;color:#f3d18a!important;
  box-shadow:inset 0 0 0 1px rgba(255,255,255,.018)!important;
}
#atoGlobalHeaderRoot .ato-menu-group{display:flex!important;flex-direction:column!important;gap:3px!important;margin:0!important;padding:0!important;overflow:visible!important}
#atoGlobalHeaderRoot .ato-about-menu .ato-menu-group::before{display:none!important;content:none!important}
#atoGlobalHeaderRoot .ato-menu-group-label{cursor:default!important;color:rgba(255,248,236,.72)!important}
#atoGlobalHeaderRoot .ato-about-menu .ato-subitem{margin:0!important;border-left:0!important;border-radius:13px!important;color:rgba(255,248,236,.84)!important}

@media (hover:hover) and (pointer:fine){
  #atoGlobalHeaderRoot .ato-grid-row:hover,
  #atoGlobalHeaderRoot .language-menu a[data-lang]:hover{
    background:linear-gradient(90deg,rgba(221,180,93,.10),rgba(55,104,146,.055))!important;
    border-color:rgba(221,180,93,.24)!important;color:#f2cf84!important;transform:translateX(1px)!important;
  }
  #atoGlobalHeaderRoot .ato-grid-row:hover .ato-grid-symbol,
  #atoGlobalHeaderRoot .language-menu a[data-lang]:hover .ato-lang-code{color:#f1cb78!important;border-right-color:rgba(241,203,120,.38)!important}
}

@media (min-width:981px){
  #atoGlobalHeaderRoot .header{z-index:260!important}
  #atoGlobalHeaderRoot .dropdown-menu,
  #atoGlobalHeaderRoot .language-menu{
    z-index:1400!important;height:auto!important;overflow:visible!important;padding:8px!important;
    background:
      radial-gradient(circle at 18% 0,rgba(221,180,93,.075),transparent 34%),
      linear-gradient(155deg,rgba(8,23,38,.975),rgba(5,15,27,.965))!important;
    -webkit-backdrop-filter:blur(20px) saturate(120%)!important;backdrop-filter:blur(20px) saturate(120%)!important;
    border:1px solid rgba(221,180,93,.28)!important;border-radius:19px!important;
    box-shadow:0 24px 58px rgba(0,0,0,.34),inset 0 1px 0 rgba(255,255,255,.035),0 0 24px rgba(64,110,148,.055)!important;
    opacity:0!important;visibility:hidden!important;pointer-events:none!important;
    transition:opacity .2s ease,visibility .2s ease,transform .22s cubic-bezier(.22,.61,.36,1)!important;
  }
  #atoGlobalHeaderRoot .dropdown-menu{top:42px!important;left:50%!important;right:auto!important;transform:translate(-50%,-6px)!important;display:flex!important;flex-direction:column!important;gap:3px!important}
  #atoGlobalHeaderRoot .ato-tours-menu{width:326px!important}
  #atoGlobalHeaderRoot .ato-special-menu{width:352px!important}
  #atoGlobalHeaderRoot .ato-about-menu{width:352px!important}
  #atoGlobalHeaderRoot .language-menu{top:calc(100% + 16px)!important;right:0!important;left:auto!important;width:262px!important;transform:translateY(-6px)!important;display:flex!important;flex-direction:column!important;gap:3px!important}

  /* Click/open-state is authoritative: never allow two hover menus at once. */
  #atoGlobalHeaderRoot .nav-dropdown:not(.open)>.dropdown-menu,
  #atoGlobalHeaderRoot .language-dropdown:not(.open)>.language-menu{opacity:0!important;visibility:hidden!important;pointer-events:none!important}
  #atoGlobalHeaderRoot .nav-dropdown.open>.dropdown-menu{opacity:1!important;visibility:visible!important;pointer-events:auto!important;transform:translate(-50%,0)!important}
  ...
  #atoGlobalHeaderRoot .language-close{display:none!important}
  #atoGlobalHeaderRoot .ato-grid-row:focus-visible,
  #atoGlobalHeaderRoot .language-menu a[data-lang]:focus-visible,
  #atoGlobalHeaderRoot .ato-dropdown-trigger:focus-visible,
  #atoGlobalHeaderRoot .ato-language-trigger:focus-visible{outline:1px solid rgba(225,185,105,.62)!important;outline-offset:2px!important}
}

@media (max-width:980px){
  #atoGlobalHeaderRoot .ato-language-trigger{gap:4px!important}
  #atoGlobalHeaderRoot .nav-dropdown>.dropdown-menu{
    position:static!important;inset:auto!important;transform:none!important;width:100%!important;max-width:none!important;
    margin:7px 0 5px!important;padding:6px!important;border:1px solid rgba(221,180,93,.20)!important;border-radius:16px!important;
    background:linear-gradient(155deg,rgba(13,31,49,.82),rgba(8,22,37,.80))!important;
    -webkit-backdrop-filter:blur(14px)!important;backdrop-filter:blur(14px)!important;
    box-shadow:inset 0 1px 0 rgba(255,255,255,.025)!important;opacity:1!important;visibility:visible!important;pointer-events:auto!important;
  }
  #atoGlobalHeaderRoot .nav-dropdown:not(.open)>.dropdown-menu{display:none!important}
  #atoGlobalHeaderRoot .nav-dropdown.open>.dropdown-menu{display:flex!important;flex-direction:column!important;gap:3px!important}
  ...
  #atoGlobalHeaderRoot .language-menu{
    ...
    -webkit-backdrop-filter:blur(20px) saturate(118%)!important;backdrop-filter:blur(20px) saturate(118%)!important;
    box-shadow:0 24px 58px rgba(0,0,0,.42),inset 0 1px 0 rgba(255,255,255,.035)!important;
    transform:translateY(-6px)!important;opacity:0!important;visibility:hidden!important;pointer-events:none!important;
    transition:opacity .2s ease,visibility .2s ease,transform .22s cubic-bezier(.22,.61,.36,1)!important;
  }
  #atoGlobalHeaderRoot .language-dropdown.open>.language-menu{opacity:1!important;visibility:visible!important;pointer-events:auto!important;transform:translateY(0)!important}
...
@media (prefers-reduced-motion:reduce){
  #atoGlobalHeaderRoot .dropdown-menu,#atoGlobalHeaderRoot .language-menu,#atoGlobalHeaderRoot .ato-grid-row,#atoGlobalHeaderRoot .ato-lang-check{transition:none!important}
}
...
@media(max-width:980px){
  ...
  /* V41: overlay blocks the background; no page-wide pointer-events disable. */
  body.ato-mobile-header-modal-open #atoGlobalHeaderRoot{
    z-index:2147483647!important;
    pointer-events:auto!important;
  }
  body.ato-mobile-header-modal-open #atoGlobalHeaderRoot .header,
  body.ato-mobile-header-modal-open #atoGlobalHeaderRoot .nav,
  body.ato-mobile-header-modal-open #atoGlobalHeaderRoot .mobile-overlay{
    pointer-events:auto!important;
  }
  body.ato-mobile-header-modal-open #atoGlobalHeaderRoot .nav{
    z-index:2147483647!important;
  }
  body.ato-mobile-header-modal-open #atoGlobalHeaderRoot .nav a[href],
  body.ato-mobile-header-modal-open #atoGlobalHeaderRoot .nav button{
    pointer-events:auto!important;
    touch-action:manipulation!important;
  }
}
...
function atoApplyHeaderLanguage(lang=atoHeaderLanguage()){
 ...
 atoSetDropdownLabel(q('.ato-special-menu [data-offer-link="group"]'),t.groupOffers);
 atoSetDropdownLabel(q('.ato-special-menu [data-offer-link="journey"]'),t.surpriseJourney);
 atoSetDropdownLabel(q('.ato-special-menu [data-offer-link="gift"]'),t.giftCertificate);
 const vip=q('.nav > a[href="/vip-service.html"] span');if(vip)vip.textContent=t.vip;
 const aboutTitle=q('[data-header-dropdown="about"] .ato-dropdown-title');if(aboutTitle)aboutTitle.textContent=t.about;
 atoSetDropdownLabel(q('.ato-about-menu > a:first-child'),t.company);
 atoSetDropdownLabel(q('.ato-menu-group-label'),t.licenses);
 atoSetDropdownLabel(q('.ato-about-menu .ato-subitem[href="/legal-information.html"]'),t.legal);
 atoSetDropdownLabel(q('.ato-about-menu .ato-subitem[href*="tursab.org.tr"]'),t.verify);
 atoSetDropdownLabel(q('.ato-about-menu > a:last-child'),t.contact);
 const search=q('#headerTourSearch .ato-search-trigger-label');if(search)search.textContent=t.search;
 const input=q('#atoHeaderSmartSearch');if(input)input.placeholder=t.ph;
 const filters=q('#atoHeaderFilters .ato-hs-filters-label');if(filters)filters.textContent=t.filters;
 const current=q('.ato-language-code-current');if(current)current.textContent=lang.toUpperCase();
 document.querySelectorAll('#atoGlobalHeaderRoot .language-menu a[data-lang]').forEach(a=>{
   const code=a.querySelector('.ato-lang-code,.ato-v8-lang-code');if(code)code.textContent=a.dataset.lang.toUpperCase();
   const active=a.dataset.lang===lang;a.classList.toggle('is-active',active);a.setAttribute('aria-current',active?'true':'false');
 });
...
function atoInitGlobalHeader(){
 ...
 const dropdowns=[...root.querySelectorAll('.ato-header-dropdown')],languageDropdown=root.querySelector('.language-dropdown'),languageTrigger=root.querySelector('.ato-language-trigger'),languageClose=root.querySelector('.language-close');
 const isMobile=()=>window.innerWidth<=980;
 const setDropdown=(dd,on)=>{if(!dd)return;dd.classList.toggle('open',!!on);dd.querySelector(':scope > .ato-dropdown-trigger')?.setAttribute('aria-expanded',on?'true':'false')};
 ...
 if(mobileBtn&&nav&&overlay){
   ...
   mobileBtn.addEventListener('keydown',e=>{if(e.key==='Enter'||e.key===' '){e.preventDefault();toggleMobile()}});
   overlay.addEventListener('click',e=>{e.preventDefault();e.stopPropagation();closeMobilePanels()});
 }
 ...
 languageTrigger?.addEventListener('click',e=>{
   ...
   closeDropdowns();if(isMobile())setMenu(false);setLanguage(on);
 });
 languageClose?.addEventListener('click',e=>{e.preventDefault();e.stopPropagation();setLanguage(false)});
 ...
 nav?.querySelectorAll('a[href]').forEach(a=>a.addEventListener('click',()=>{
   /* V41: on mobile, leave the native anchor completely untouched before navigation. */
   if(isMobile()) return;
   closeDropdowns();
 }));
 /* All ordinary drawer anchors deliberately use native browser navigation. */
 window.addEventListener('hashchange',()=>{if(isMobile())closeMobilePanels()},{passive:true});
 document.addEventListener('click',e=>{
   if(isMobile()&&e.target.closest('#atoGlobalHeaderRoot a[href]')) return;
 ...
 const here=location.pathname.replace(/\/+$/,'')||'/index.html',hash=location.hash||'';
 root.querySelectorAll('a[href]').forEach(a=>{
   try{
     const u=new URL(a.href,location.href),p=u.pathname.replace(/\/+$/,'')||'/index.html';
     const exact=p===here&&((!u.hash&&!hash)||(!!u.hash&&u.hash===hash));
     a.classList.toggle('is-current',exact);
   }catch(_){}
 });
 dropdowns.forEach(dd=>dd.classList.toggle('is-current-section',!!dd.querySelector('a.is-current')));
 if(here==='/special-offers.html')root.querySelector('[data-header-dropdown="offers"]')?.classList.add('is-current-section');
...
/* ========================================================================
   ATO HEADER — DIRECT-TEXT DEDUPE GUARD
   Keeps exactly one visible label in premium grid rows.
   Removes only stray direct text nodes created by legacy language handlers.
   Does not change icons, links, layout, promo ribbon, search, languages,
   mobile behavior or Assistant.
   ======================================================================== */
(function atoHeaderDirectTextDedupeGuard(){
  'use strict';

  function cleanRow(row){
    if(!row) return;
    const label = row.querySelector(':scope > .ato-dropdown-label, :scope > .ato-grid-label');
    if(!label) return;
  ...
  function cleanAll(){
    const root = document.getElementById('atoGlobalHeaderRoot');
    if(!root) return;
    root.querySelectorAll('.ato-grid-row').forEach(cleanRow);
  }
  ...
  function start(){
    ...
    window.addEventListener('ato-language-changed',cleanAll);
  }
...
/* ========================================================================
   ATO MOBILE V41 — TOUCH VISIBILITY GATE
   ======================================================================== */
(function atoMobileV41TouchVisibility(){
  function install(){
    if(document.getElementById('ato-mobile-v41-touch-visibility')) return;
    const st=document.createElement('style');
    st.id='ato-mobile-v41-touch-visibility';
    st.textContent=`@media(max-width:980px){
      #atoGlobalHeaderRoot .ato-header-dropdown:not(.open)>.dropdown-menu,
      #atoGlobalHeaderRoot .nav-dropdown:not(.open)>.dropdown-menu{display:none!important;opacity:0!important;visibility:hidden!important;pointer-events:none!important}
      #atoGlobalHeaderRoot .ato-header-dropdown.open>.dropdown-menu,
      #atoGlobalHeaderRoot .nav-dropdown.open>.dropdown-menu{display:block!important;opacity:1!important;visibility:visible!important;pointer-events:auto!important}
      #atoGlobalHeaderRoot .language-dropdown:not(.open)>.language-menu{opacity:0!important;visibility:hidden!important;pointer-events:none!important}
      #atoGlobalHeaderRoot .language-dropdown.open>.language-menu{opacity:1!important;visibility:visible!important;pointer-events:auto!important}
      #atoGlobalHeaderRoot .nav a[href],#atoGlobalHeaderRoot .nav .dropdown-menu a[href]{min-height:44px!important;pointer-events:auto!important;touch-action:manipulation!important}
    }`;
    document.head.appendChild(st);
  }
...
(function atoMobileNavigationV37(){
  ...
  /* V41: no document-wide navigation MutationObserver. */
})();
