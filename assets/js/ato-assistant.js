(() => {
  ...
  function injectOrbStyles(){
    ...
    style.textContent=`
      ...
      /* ============================================================
         ASSISTANT PANEL — SELF-CONTAINED VISIBILITY + GEOMETRY FIX
         The panel no longer depends on an external display:none rule.
         It is always rendered geometrically, but invisible until .is-open.
         This also lets the existing V7/V9 desktop decorator detect it.
         ============================================================ */

      html body #atoAssistantRoot{
        overflow:visible!important;
      ...
      html body #atoAssistantPanel{
        ...
        margin:0!important;
        padding:0!important;
        border:1px solid rgba(215,168,62,.68)!important;
        border-radius:24px!important;

        background:
          radial-gradient(115% 92% at 13% 2%,rgba(69,149,226,.24) 0%,rgba(33,106,176,.08) 33%,transparent 58%),
          radial-gradient(94% 82% at 94% 94%,rgba(22,145,111,.22) 0%,rgba(10,99,80,.08) 34%,transparent 67%),
          linear-gradient(136deg,#103158 0%,#0d3552 25%,#0b4050 48%,#08483f 70%,#06362f 87%,#042622 100%)!important;

        color:#f8f5ec!important;
        box-shadow:
          0 36px 110px rgba(0,0,0,.56),
          0 0 0 1px rgba(222,178,89,.16),
          0 0 62px rgba(28,112,155,.11),
          inset 0 1px 0 rgba(255,255,255,.045),
          inset 0 -56px 80px rgba(0,28,25,.12)!important;
      ...
      html body #atoAssistantPanel .ato-assistant-eyebrow{
        ...
        color:rgba(240,207,137,.94)!important;
      ...
      html body #atoAssistantPanel .ato-assistant-status{
        ...
        color:rgba(234,231,220,.82)!important;
        font:800 9px/1.2 Arial,sans-serif!important;
        letter-spacing:.11em!important;
        text-transform:uppercase!important;
      }

      html body #atoAssistantPanel .ato-assistant-status span{
        width:6px!important;
        height:6px!important;
        flex:0 0 6px!important;
        border-radius:50%!important;
        background:#e8b64f!important;
        box-shadow:0 0 9px rgba(232,182,79,.32)!important;
      }

      html body #atoAssistantPanel .ato-assistant-head__actions{
        display:flex!important;
        align-items:center!important;
        gap:9px!important;
      }

      html body #atoAssistantPanel .ato-assistant-head__actions button{
      ...
      html body #atoAssistantPanel .ato-assistant-head__actions button:hover{
        border-color:rgba(232,182,79,.48)!important;
        background:rgba(232,182,79,.07)!important;
      ...
      html body #atoAssistantPanel .ato-assistant-thread{
        ...
        scrollbar-color:rgba(111,153,174,.36) transparent!important;
      }

      html body #atoAssistantPanel .ato-assistant-msg{
        margin:0 0 13px!important;
      }

      html body #atoAssistantPanel .ato-assistant-msg__label{
        margin:0 0 6px!important;
        color:rgba(240,207,137,.76)!important;
        font:800 8px/1.1 Arial,sans-serif!important;
        letter-spacing:.12em!important;
        text-transform:uppercase!important;
      }

      html body #atoAssistantPanel .ato-assistant-msg__body{
        max-width:100%!important;
        padding:12px 14px!important;
        border:1px solid rgba(112,179,201,.18)!important;
        border-radius:12px!important;
        background:linear-gradient(105deg,rgba(18,58,86,.68),rgba(10,67,68,.43))!important;
        color:#f8f6f0!important;
        font:500 13px/1.45 Arial,sans-serif!important;
        box-shadow:inset 0 1px 0 rgba(255,255,255,.025)!important;
      }

      html body #atoAssistantPanel .ato-assistant-msg--user .ato-assistant-msg__body{
        margin-left:auto!important;
        border-color:rgba(221,180,93,.25)!important;
        background:linear-gradient(105deg,rgba(92,67,26,.28),rgba(10,64,64,.43))!important;
      }
      ...
      html body #atoAssistantPanel .ato-assistant-chips button{
        min-height:31px!important;
        margin:0!important;
        padding:0 12px!important;
        border:1px solid rgba(215,168,62,.52)!important;
        border-radius:999px!important;
        background:linear-gradient(110deg,rgba(12,44,65,.55),rgba(7,64,58,.40))!important;
      ...
      html body #atoAssistantPanel .ato-assistant-chips button:hover{
        color:#f0cf89!important;
        border-color:rgba(232,182,79,.78)!important;
      ...
      html body #atoAssistantPanel #atoAssistantManager{
        width:100%!important;
        ...
        border:1px solid rgba(215,168,62,.56)!important;
        border-radius:999px!important;
        background:linear-gradient(90deg,rgba(11,42,60,.56),rgba(6,64,56,.40))!important;
        color:#fff9ef!important;
        font-family:"Cormorant Garamond",Georgia,"Times New Roman",serif!important;
      ...
      html body #atoAssistantPanel #atoAssistantManager b{
        color:#f0cf89!important;
      ...
      html body #atoAssistantPanel #atoAssistantInput{
        ...
        border:1px solid rgba(92,203,210,.62)!important;
        border-radius:14px!important;
        outline:none!important;
        background:linear-gradient(100deg,rgba(7,32,47,.78),rgba(5,54,49,.60))!important;
        color:#fff9ef!important;
        caret-color:#e8b64f!important;
        font:500 13px/1.4 Arial,sans-serif!important;
        box-shadow:
          0 0 0 1px rgba(215,168,62,.12),
          0 0 20px rgba(55,180,193,.13)!important;
      }

      html body #atoAssistantPanel #atoAssistantInput::placeholder{
        color:rgba(221,226,225,.66)!important;
      }

      html body #atoAssistantPanel #atoAssistantSend{
        width:52px!important;
        min-width:52px!important;
        height:52px!important;
        margin:0!important;
        padding:0!important;
        border:1px solid rgba(215,168,62,.64)!important;
        border-radius:14px!important;
        background:linear-gradient(145deg,rgba(16,60,78,.84),rgba(7,73,62,.68))!important;
        color:#f0cf89!important;
      ...
      html body #atoAssistantPanel .ato-assistant-fineprint{
        ...
        color:rgba(214,224,222,.66)!important;
        font:800 7px/1.3 Arial,sans-serif!important;
